...
import imaginaryBrickImg from "../../images/icons/imaginaryBrick.png"
import cosmicKnowledgeImg from "../../images/icons/cosmicKnowledge.png"
...
const PixelIconBase: FC<PixelBaseProps> = ({src, name, size, style}) => {
    const sizeValue = size === "sm" ? "2em" 
                        :(size === "md" ? "2.4em" 
                        :(size === "lg" ? "3em" 
                        : "1em")) 

    return <img src={src} alt={name} style={{width: sizeValue, padding: '4px', ...style}}/>
}

type PixelProps = {size: "sm" | "md" | "lg", style?: React.CSSProperties}
